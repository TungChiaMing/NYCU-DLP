...
class DDPG:
    ...
    def select_action(self, state, noise=False):
        ...
        '''
        input state to actor network, output action
        '''
        ...
        with torch.no_grad():
            ...
            if noise:
                sampled_noise = torch.from_numpy(self._action_noise.sample()).to(self.device)
    ...
    def _update_target_network(target_net, net, tau):
        ...
        for target, behavior in zip(target_net.parameters(), net.parameters()):
            ...
            target.data.copy_(  # copy data from behavior network to target network
...
def train(args, env, agent, writer):
    ...
    for episode in range(args.episode):
        ...
        if episode % 100 == 0 and episode != 0:
            ...
            agent.save("ddpg" + str(episode) + ".pth")
